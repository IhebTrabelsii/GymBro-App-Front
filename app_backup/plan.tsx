            ...
            <View style={styles.heroContent}>
              <View style={[styles.iconCircle, { 
                ...
                <MaterialCommunityIcons 
                  name={plan === 'Ectomorph' ? 'leaf' : plan === 'Mesomorph' ? 'arm-flex' : 'run'} 
                  size={40} 
            ...
            >
              <View style={[styles.planCard, { 
                ...
                <View style={styles.planHeader}>
                  <View style={styles.planTitleContainer}>
                    <View style={[styles.planIcon, { 
                      ...
                      <Ionicons name="barbell" size={18} color={currentColors.primary} />
                    </View>
                    <Text style={[styles.planTitle, { color: currentColors.primary }]}>
                      {planItem.title}
                    </Text>
                  </View>
                </View>
                ...
                <View style={styles.focusContainer}>
                  ...
                  <Text style={[styles.planFocus, { color: isDark ? currentColors.text : '#666' }]}>
                    {planItem.focus}
                  </Text>
                </View>
                  ...
                  {planItem.days.map((day, dayIndex) => (
                    <View key={dayIndex} style={styles.dayItem}>
                      <View style={[styles.dayIcon, { 
                        ...
                        <Ionicons name="calendar-outline" size={14} color={currentColors.primary} />
                      </View>
                ...
                <View style={[styles.tipsContainer, { 
                  backgroundColor: isDark ? 'rgba(57, 255, 20, 0.1)' : 'rgba(57, 255, 20, 0.05)' 
                }]}>
        ...
        >
          <View style={[styles.infoCard, { 
            ...
            <Text style={[styles.infoText, { 
              ...
              Follow your chosen plan consistently for 6-8 weeks. Track your progress, adjust weights as needed, and ensure proper nutrition and recovery for best results.
            </Text>
          </View>
        </MotiView>
      </ScrollView>
