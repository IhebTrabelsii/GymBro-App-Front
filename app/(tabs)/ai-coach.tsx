...
export default function AICoachTab() {
  ...
  const handleUpgradePress = () => {
    router.push("/premium"); // ✅ This will work with index.tsx
  };
  ...
  const handleAskQuestion = () => {
    if (userPlan === "free") {
      ...
      Alert.alert(
        "Coming Soon",
        "AI Coach will be available in the next update!",
      );
    }
  };
    ...
    >
      ...
      >
          ...
          >
            <View style={styles.upgradeBannerContent}>
              ...
              <Text style={styles.upgradeBannerText}>
                Get personalized workout plans, nutrition advice, and 24/7
                coaching
              </Text>
              <TouchableOpacity
                style={[
        ...
        >
          ...
          {userPlan === "free" && (
            <Text
              style={[styles.freeNote, { color: isDark ? "#888" : "#666" }]}
            >
        ...
        {userPlan !== "free" && (
          ...
          >
            ...
            >
              We're training your personal AI coach. Check back in the next
              update!
            </Text>
          </Animated.View>
        )}
