...
const handleAddAnalyzedFood = (food: any) => {
  Alert.alert(
    'Add to Meal',
    `Add ${food.foodName} (${food.calories} cal) to your meal?`,
    [
      { text: 'Cancel', style: 'cancel' },
      { text: 'Add', onPress: () => console.log('Added:', food) }
    ]
  );
};
  ...
  return (
    ...
    >
          ...
          <View>
            ...
            <View style={styles.headerSubRow}>
              ...
              >
                {loadingFoods
                  ? "Loading…"
                  : `${processedFoods.length} food${processedFoods.length !== 1 ? "s" : ""} available`}
              </Text>
            </View>
          </View>
     ...
     <FoodAnalyzer 
  onAddFood={handleAddAnalyzedFood}
  theme={theme}
...
/>
      ...
      >
        <Ionicons
          ...
          size={16}
          color={
            filtersActive ? currentColors.primary : isDark ? "#555" : "#bbb"
          }
        />
        <Text
          style={[
      ...
      {showFilters && (
        ...
        >
          <Text
            style={[styles.filterLabel, { color: isDark ? "#444" : "#ccc" }]}
          >
            CATEGORY
          </Text>
          <ScrollView
                ...
                >
                  ...
                  <Text
                    style={[
                      ...
                      { color: active ? meta.color : isDark ? "#666" : "#aaa" },
                    ]}
                  >
                    {cat}
                  </Text>
          ...
          <Text
            style={[
              styles.filterLabel,
              { color: isDark ? "#444" : "#ccc", marginTop: 14 },
            ]}
          >
            SORT BY
          </Text>
      ...
      >
        {loadingFoods ? (
          <View style={styles.loadingContainer}>
            ...
            <Text
              style={[styles.loadingText, { color: isDark ? "#444" : "#ccc" }]}
            >
              ...
              return viewMode === "list" ? (
                ...
                >
                  ...
                  <View style={styles.foodInfo}>
                    <Text
                      style={[styles.foodName, { color: currentColors.text }]}
                      numberOfLines={1}
                    >
                      {food.name}
                    </Text>
                    ...
                    <View style={styles.macroRow}>
                      {[
                        ...
                        <View key={m.label} style={styles.macroPill}>
                          <Text
                            style={[styles.macroPillLabel, { color: m.color }]}
                          >
                            {m.label}
                          </Text>
                          <Text
                  ...
                  <View style={styles.foodCardRight}>
                    <Text style={[styles.foodCalories, { color: catColor }]}>
                      {food.calories}
                    </Text>
                    <Text
                      style={[
                ...
                >
                  ...
                  >
                    <Text style={styles.gridFoodEmoji}>
                      {food.image || "🍗"}
                    </Text>
                  </View>
                  <Text
                  ...
                  <Text style={[styles.gridCalories, { color: catColor }]}>
                    {food.calories} kcal
                  </Text>
                  <Text
                    style={[
          ...
          <View style={styles.emptyState}>
            ...
            <Text
              style={[styles.emptyText, { color: isDark ? "#444" : "#ccc" }]}
            >
              No foods found
            </Text>
            <Text
              style={[styles.emptySubtext, { color: isDark ? "#333" : "#ddd" }]}
            >
        ...
        <Pressable style={styles.overlay} onPress={closeModal}>
          <Animated.View
            style={[
              ...
              {
                backgroundColor: isDark ? "#0e0e0e" : "#fff",
                borderColor: selectedFood
                  ? getCategoryColor(selectedFood.category) + "50"
                  : currentColors.primary + "50",
              ...
              (() => {
                ...
                return (
                  <>
                    {}
                    <View
                      style={[styles.modalStrip, { backgroundColor: catColor }]}
                    />
                    ...
                    <Text
                      style={[styles.popupTitle, { color: currentColors.text }]}
                    >
                      {selectedFood.name}
                    </Text>
                    ...
                    >
                      ...
                      />
                      <Text
                        style={[styles.popupCategoryText, { color: catColor }]}
                      >
                    ...
                    >
                      ...
                      <Text style={[styles.popupCalories, { color: catColor }]}>
                    ...
                    <View style={styles.macrosGrid}>
                      {[
                        {
                          label: "💪 Protein",
                          val: selectedFood.protein,
                          color: "#FF6B6B",
                          max: 40,
                        },
                        {
                          label: "⚡ Carbs",
                          val: selectedFood.carbs,
                          color: "#FFC107",
                          max: 50,
                        },
                        {
                          label: "🥑 Fat",
                          val: selectedFood.fat,
                          color: "#FF9500",
                          max: 30,
                        },
                      ].map((m) => (
                        ...
                        >
                          <Text style={[styles.macroLabel, { color: m.color }]}>
                            {m.label}
                          </Text>
                          <Text
                            style={[
                    ...
                    <View
                      style={[
                        styles.benefitContainer,
                        {
                          ...
                          borderColor: isDark ? "#1e1e1e" : "#efefef",
                        },
                      ]}
                    >
                      <View style={styles.benefitHeader}>
                        ...
                        <Text
                          style={[styles.benefitLabel, { color: catColor }]}
                        >
                          Benefits
                        </Text>
                      </View>
