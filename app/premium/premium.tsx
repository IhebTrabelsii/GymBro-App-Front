      ...
      Alert.alert(
        ...
        [
          { text: "Cancel", style: "cancel" },
          {
            ...
            onPress: () => handleSuccessfulPayment(),
          },
        ],
      );
  ...
  const handleSuccessfulPayment = async () => {
    try {
      ...
      if (response.ok && data.success) {
        ...
        Alert.alert(
          "Error",
          data.error || "Upgrade failed. Please contact support.",
        );
      }
    } catch (error) {
  ...
  return (
    ...
    >
      ...
      >
        ...
        >
          <View
            style={[styles.crownIcon, { backgroundColor: primaryColor + "20" }]}
          >
          ...
          <Text
            style={[styles.heroSubtitle, { color: isDark ? "#888" : "#666" }]}
          >
        ...
        <View style={styles.currencyToggle}>
          ...
          >
            <Text
              style={[
                styles.currencyText,
                currency === "USD" && { color: primaryColor },
              ]}
            >
              USD $
            </Text>
          ...
          >
            <Text
              style={[
                styles.currencyText,
                currency === "TND" && { color: primaryColor },
              ]}
            >
              TND د.ت
            </Text>
                  ...
                  <View style={styles.radioButton}>
                    <View
                      style={[
                        ...
                        {
                          borderColor:
                            selectedPlan === plan.id ? primaryColor : "#888",
                        },
                      ]}
                    >
                      {selectedPlan === plan.id && (
        ...
        >
          <Text
            style={[styles.summaryTitle, { color: isDark ? "#FFF" : "#000" }]}
          >
        ...
        >
          ...
          <Text
            style={[styles.guaranteeText, { color: isDark ? "#888" : "#666" }]}
          >
        ...
        >
          ...
          >
            <Text
              style={[styles.restoreText, { color: isDark ? "#888" : "#666" }]}
            >
              Restore Purchase
            </Text>
          </TouchableOpacity>
          ...
          >
            ...
            {!showD17Form ? (
              ...
              <View style={styles.d17Form}>
                ...
                <View style={styles.d17InputGroup}>
                  ...
                  <TextInput
                    ...
                    onChangeText={(text) =>
                      setD17Form({
                        ...d17Form,
                        cardNumber: formatD17CardNumber(text),
                      })
                    }
                ...
                <View style={styles.d17Row}>
                  <View
                    style={[styles.d17InputGroup, { flex: 1, marginRight: 8 }]}
                  >
                    <Text
                      style={[
                        styles.d17Label,
                  ...
                  <View
                    style={[styles.d17InputGroup, { flex: 1, marginLeft: 8 }]}
                  >
                    <Text
                      style={[
                        styles.d17Label,
            ...
            <TouchableOpacity
              ...
              disabled={
                ...
                (selectedPaymentMethod === "d17" &&
                  (!d17Form.cardNumber || !d17Form.expiryDate || !d17Form.cvv))
              }
            >
              {loading ? (
            ...
            <Text
              style={[styles.secureText, { color: isDark ? "#888" : "#666" }]}
            >
              {selectedPaymentMethod === "d17"
