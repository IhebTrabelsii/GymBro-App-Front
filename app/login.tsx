...
export default function LoginScreen() {
  ...
  const handleLogin = async () => {
    ...
    try {
      ...
      const data = await response.json() as { token?: string; username?: string; error?: string };
        ...
        >
            ...
            <View style={[styles.heroCard, { 
              ...
              <View style={styles.heroContent}>
                <View style={[styles.iconCircle, { 
                  ...
                  <MaterialCommunityIcons name="login" size={40} color={currentColors.primary} />
                </View>
              ...
              <View style={styles.inputGroup}>
                <View style={styles.inputLabelContainer}>
                  <View style={[styles.inputIcon, { 
                    ...
                    <Ionicons name="mail" size={18} color={currentColors.primary} />
                  </View>
              ...
              <View style={styles.inputGroup}>
                <View style={styles.inputLabelContainer}>
                  <View style={[styles.inputIcon, { 
                    ...
                    <Ionicons name="lock-closed" size={18} color={currentColors.primary} />
                  </View>
                  <Text style={[styles.inputLabel, { color: currentColors.text }]}>
                    Password
                  </Text>
          ...
          <View>
            <View style={styles.signupContainer}>
              <Text style={[styles.signupText, { color: isDark ? currentColors.text : '#666' }]}>
