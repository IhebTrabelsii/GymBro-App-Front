...
Curated fitness and wellness content providing educational articles, training tips, research updates, and lifestyle guidance. Delivers latest industry information to keep users informed about fitness trends and best practices. The current project includes this as an archived page in `app/(tabs)/news.tsx.bak`.
...
- Expo ^55.0.0 - Development platform and distribution service
- Expo Router ~55.0.14 - File-based routing for React Native
- React 19.2.0 - Component library and state management

### UI & Animation

- React Native Reanimated 4.2.1 - High-performance animations
- Expo Linear Gradient ~55.0.14 - Gradient rendering components
...
- TensorFlow Pose Detection ^2.1.3 - Machine learning pose detection model
- Mediapipe Pose ~0.5.0 - Pose estimation and form analysis
- Groq API integration - Language model for AI coaching

### Camera & Media

- Expo Camera ~55.0.18 - Camera access and capture
- Expo Image Picker ~55.0.20 - Image selection and upload
- Expo Image Manipulator ~55.0.16 - Image processing and resizing
- Expo Video Thumbnails ~55.0.15 - Video preview generation
- Expo Linking ~55.0.15 - Deep linking and URL handling

### Authentication & Security

- JWT (jsonwebtoken 9.0.3) - Token-based authentication
- Bcryptjs 3.0.3 - Password hashing and encryption
- Expo Auth Session ~55.0.16 - OAuth and authentication flows
- Expo Web Browser ~55.0.16 - External browser integration
...
- Stripe React Native 0.63.0 - Payment integration and processing
...
- Expo Haptics ~55.0.14 - Device vibration feedback
- Expo Sharing ~55.0.19 - File sharing and exports
...
│   │   ├── news.tsx.bak           # Archived fitness news content
...
│   │   ├── hydration.tsx         # Hydration tracking configuration
│   │   ├── plan.tsx              # Plan configuration
│   │   └── schedule.tsx          # Schedule configuration
...
├── app/utils/                     # App utilities and helper modules
